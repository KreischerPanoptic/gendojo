...
export const MODEL_PRESETS: ModelPreset[] = [
...

  {
    ...
    description:
      "FLUX.1-dev base DiT. Gated — accept license at huggingface.co/black-forest-labs/FLUX.1-dev and set HF_TOKEN.",
  },
  {
    id: "flux-schnell-dit",
    ...
    requiresHfToken: true,
    description:
      "FLUX.1-schnell base DiT. Distilled, faster inference. Gated — set HF_TOKEN.",
  },
  {
    id: "flux-ae",
...

  {
    ...
    requiresHfToken: false,
    description:
      "Stable Diffusion XL Base 1.0 (all-in-one checkpoint, includes CLIP-L, CLIP-G, VAE, U-Net).",
  },
  {
    ...
    requiresHfToken: false,
    description:
      "SDXL VAE with fp16 NaN fix by madebyollin. Strongly recommended over stock VAE for training.",
  },
...

  {
    ...
    requiresHfToken: false,
    description:
      "Stable Diffusion 1.5, EMA-only pruned. Standard base for SD1 LoRA training.",
  },
  {
    id: "sd1-vae-ft-mse",
...

  {
    ...
    requiresHfToken: true,
    description:
      "SD 3.5 Large (single-file, includes VAE + all text encoders). Gated — accept license and set HF_TOKEN.",
  },
  {
    id: "sd35-medium-dit",
    ...
    requiresHfToken: true,
    description:
      "SD 3.5 Medium (single-file, includes VAE + all text encoders). Gated — set HF_TOKEN.",
  },
  {
    id: "sd3-medium-dit",
    ...
    requiresHfToken: true,
    description:
      "SD 3 Medium (single-file, includes VAE + all text encoders). Gated — set HF_TOKEN.",
  },
  ...
  },
  {
    ...
    requiresHfToken: false,
    description:
      "Gemma2 2B fp16 — sole text encoder for Lumina Image 2.0. Passed as --gemma2.",
  },
  {
    id: "lumina2-ae",
...

  {
    ...
    requiresHfToken: false,
    description:
      "HunyuanImage 2.1 DiT. Requires Qwen2.5-VL + byT5 text encoders + HunyuanImage VAE.",
  },
  {
    ...
    requiresHfToken: false,
    description:
      "Qwen2.5-VL 7B — primary text encoder for HunyuanImage 2.1. ~15 GB.",
  },
  {
    id: "hunyuan-byt5",
    ...
    requiresHfToken: false,
    description:
      "byT5-small (GlyphXL, fp16) — secondary text encoder for HunyuanImage 2.1.",
  },
  {
    id: "hunyuan-vae",
...

  {
    ...
    requiresHfToken: false,
    description:
      "Anima DiT base weights (preview). Requires Qwen-Image VAE + Qwen3-0.6B text encoder.",
  },
  {
    id: "anima-2-dit",
    name: "Anima 2 (DiT)",
    ...
    source: "huggingface",
    hfRepoId: "circlestone-labs/Anima",
    hfFilename: "split_files/diffusion_models/anima-preview2.safetensors",
    filename: "anima-preview2.safetensors",
    sizeMb: 4_180,
    requiresHfToken: false,
    description:
      "Anima DiT base weights (preview 2). Requires Qwen-Image VAE + Qwen3-0.6B text encoder.",
  },
  {
    ...
    requiresHfToken: false,
    description:
      "Qwen-Image VAE for Anima. NOT compatible with SDXL, SD3, FLUX AE, or other architecture VAEs.",
  },
  {
    id: "anima-qwen3-06b",
